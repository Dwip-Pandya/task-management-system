        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow border-primary">
                ...
                <div class="card-footer d-flex">
                    <a href="{{ route('projectmanager.tasks.show', $t->task_id) }}" class="btn btn-info btn-sm">Details</a>
                    <a href="{{ route('projectmanager.tasks.edit', $t->task_id) }}" class="btn btn-warning btn-sm ms-1">Edit</a>
                </div>
            </div>
        </div>
        @endforeach
